...
read_chunk( path=file.path( WORKING_DIR, "05_prepareArticleFigures.R"));
read_chunk( path=file.path( WORKING_DIR, "80_exportData.R"));
```

---
title: `r paste(SAMPLE_NAME, "-", PROJECT_NAME, "-", LITERAL_TITLE, "-", CURRENT_TISSUE)`
---
