...
LITERAL_TITLE = "Analysis of cell heterogeneity (No BCR) by tissue, filtering the cells affected by cell dissociation process" 
ANALYSIS_STEP_NAME = "10_GlobalHeterogeneityNoBCRByTissue_FilterDissociation"
PATH_ANALYSIS_OUTPUT = file.path( PATH_EXPERIMENT_OUTPUT, ANALYSIS_STEP_NAME)

# Original data after QC and demultiplexing
...
DISSOCIATION_AFFECTED_CELLS_CLUSTER = list( 
  LG = 2, 
  LN = NA,
  SP = NA
)
...
MONITORED_GENES = list( GC             = c( "Aicda", "Bach2", "Aurka", "Bcl2a1b", "Bcl6", "Ccnb1", "Ccnb2", "Ccne1", "Cenpa", "Efnb1", "Ezh2", "Fas", "Gna13", "Il4i1", "Mcm6", "Mki67", "Polh", "Rad51", "S1pr2", "Slamf1"),
                        ...
                        MEMORY_B       = c( "Cxcr3", "Ccr6", "Cd55", "Ighd", "Ighm", "Cd80", "Pdcd1lg2", "Nt5e"),
