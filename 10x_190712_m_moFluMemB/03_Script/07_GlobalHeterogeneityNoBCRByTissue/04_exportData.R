...
# Export marker genes for each cluster
pairwise_marker_genes_table_file = file.path( PATH_ANALYSIS_OUTPUT, paste0( "pairwiseMarkers_", CURRENT_TISSUE, ".tab"))
cat("<br>Exporting pairwise marker genes table :", pairwise_marker_genes_table_file)
write.table( pairwise_markers, file = pairwise_marker_genes_table_file,
             sep="\t", row.names = FALSE, col.names = TRUE, quote = FALSE)
