...
sc10x.rna.seurat = RunTSNE( sc10x.rna.seurat, dims = 1:DIMREDUC_USE_PCA_NBDIMS);
sc10x.rna.seurat = RunUMAP( sc10x.rna.seurat, dims = 1:DIMREDUC_USE_PCA_NBDIMS);
...
# ..............................................................................
mean_pctzero_df = as.data.frame( cbind(  apply( sc10x.rna.seurat@assays$RNA@counts, 1, mean), 
                                         apply( sc10x.rna.seurat@assays$RNA@counts, 1, function( column){
