...
ANALYSIS_STEP_NAME = "12_CompareTissues_FilterDissociation"
...
PATH_ALL_MARKER_GENES_TABLE_FILE = list(
  LG = file.path( PATH_EXPERIMENT_OUTPUT, "/10_GlobalHeterogeneityNoBCRByTissue_FilterDissociation/allMarkers_LG.tab"),
  LN = file.path( PATH_EXPERIMENT_OUTPUT, "/10_GlobalHeterogeneityNoBCRByTissue_FilterDissociation/allMarkers_LN.tab"),
  SP = file.path( PATH_EXPERIMENT_OUTPUT, "/10_GlobalHeterogeneityNoBCRByTissue_FilterDissociation/allMarkers_SP.tab")
)

# The list of top markers genes per tissue and per cluster in tissue
PATH_TOP_MARKER_GENES_TABLE_FILE = list(
  LG = file.path( PATH_EXPERIMENT_OUTPUT, "/10_GlobalHeterogeneityNoBCRByTissue_FilterDissociation/topMarkersDT_LG.tab"),
  LN = file.path( PATH_EXPERIMENT_OUTPUT, "/10_GlobalHeterogeneityNoBCRByTissue_FilterDissociation/topMarkersDT_LN.tab"),
  SP = file.path( PATH_EXPERIMENT_OUTPUT, "/10_GlobalHeterogeneityNoBCRByTissue_FilterDissociation/topMarkersDT_SP.tab")
)

# The list of UMAP embedding per tissue
PATH_UMAP_EMBEDDING_FILE = list(
  LG = file.path( PATH_EXPERIMENT_OUTPUT, "/10_GlobalHeterogeneityNoBCRByTissue_FilterDissociation/UMAP_Embedding_LG.tab"),
  LN = file.path( PATH_EXPERIMENT_OUTPUT, "/10_GlobalHeterogeneityNoBCRByTissue_FilterDissociation/UMAP_Embedding_LN.tab"),
  SP = file.path( PATH_EXPERIMENT_OUTPUT, "/10_GlobalHeterogeneityNoBCRByTissue_FilterDissociation/UMAP_Embedding_SP.tab")
)

# The list of cluster mapping per tissue
PATH_CLUSTER_MAPPING_FILE = list(
  LG = file.path( PATH_EXPERIMENT_OUTPUT, "/10_GlobalHeterogeneityNoBCRByTissue_FilterDissociation/clusters_LG.tab"),
  LN = file.path( PATH_EXPERIMENT_OUTPUT, "/10_GlobalHeterogeneityNoBCRByTissue_FilterDissociation/clusters_LN.tab"),
  SP = file.path( PATH_EXPERIMENT_OUTPUT, "/10_GlobalHeterogeneityNoBCRByTissue_FilterDissociation/clusters_SP.tab")
)

# The list of variable genes expression file per tissue
PATH_VARIABLE_GENES_EXPRESSION_FILE = list(
  LG = file.path( PATH_EXPERIMENT_OUTPUT, "/10_GlobalHeterogeneityNoBCRByTissue_FilterDissociation/normalizedExpressions_LG.tsv"),
  LN = file.path( PATH_EXPERIMENT_OUTPUT, "/10_GlobalHeterogeneityNoBCRByTissue_FilterDissociation/normalizedExpressions_LN.tsv"),
  SP = file.path( PATH_EXPERIMENT_OUTPUT, "/10_GlobalHeterogeneityNoBCRByTissue_FilterDissociation/normalizedExpressions_SP.tsv")
)

# The path to the file containing the Clonotype analysis info and some Seurat analysis info
PATH_CLONOTYPE_AND_SEURAT_DATA_FILE = file.path( PATH_EXPERIMENT_OUTPUT, "08_BCRRepertoire/clonotype_and_seurat_merged_data.tsv")
