...
#### tSNE {.tabset .tabset-fade}
```{r heterogeneity_sample_compatibility_plot_tSNE, fig.keep = "all", fig.dim = c(3,3), out.width='25%'}
useReduction='tsne';
...
#### UMAP {.tabset .tabset-fade}
```{r heterogeneity_sample_compatibility_plot_UMAP, fig.keep = "all", fig.dim = c(3,3), out.width='25%'} 
useReduction='umap'
...
### Analysis of marker genes between tissues 

In this section we look at the gene differentially expressed between tissues. The comparison is done from one tissue to the group of the two others.

```{r marker_genes_between_tissue, fig.keep = "all", message=FALSE} 
<<marker_genes_between_tissue>>
```

### Export data

```{r export_data, fig.keep = "all", message=FALSE} 
saveRDS( sc10x.rna.seurat, file = file.path( PATH_ANALYSIS_OUTPUT, "sc10x.rna.seurat"))
```
