...
for( CURRENT_TISSUE in names( SUBSAMPLE_BY_TISSUE)){
  ...
  rmarkdown::render( input = file.path( WORKING_DIR, "moFluMemB_07_GlobalHeterogeneityNoBCRByTissue.Rmd"),
                     output_dir = PATH_ANALYSIS_OUTPUT,
                     output_file  = paste0( "moFluMemB_07_GlobalHeterogeneityNoBCRByTissue", "_", CURRENT_TISSUE, ".html"),
                     quiet = FALSE)  
