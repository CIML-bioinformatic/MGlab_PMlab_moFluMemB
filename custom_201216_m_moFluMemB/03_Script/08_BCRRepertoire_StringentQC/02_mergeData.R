...
cell_vsegment_exact_heavy_names = heavy_and_light_chains_df[ Cells( custom.rna.seurat), "v.segment.exact.heavy"]
custom.rna.seurat = AddMetaData( object = custom.rna.seurat, 
                                 metadata = cell_vsegment_exact_heavy_names, 
                                 col.name = "v.segment.exact.heavy")
cell_vsegment_exact_light_names = heavy_and_light_chains_df[ Cells( custom.rna.seurat), "v.segment.exact.light"]
custom.rna.seurat = AddMetaData( object = custom.rna.seurat, 
...
Idents( custom.rna.seurat) = "v.segment.exact.heavy"
clonotype_seurat_df$v.segment.exact.heavy = Idents( custom.rna.seurat)[ row.names( clonotype_seurat_df)]
...
Idents( custom.rna.seurat) = "v.segment.exact.light"
clonotype_seurat_df$v.segment.exact.light = Idents( custom.rna.seurat)[ row.names( clonotype_seurat_df)]
