...
ANALYSIS_STEP_NAME = "08_BCRRepertoire_StringentQC"
...
PATH_SEURAT_FILTERED_OBJECT = file.path( PATH_EXPERIMENT_OUTPUT, "06_GlobalHeterogeneityNoBCR_StringentQC")
PATH_SEURAT_FILTERED_OBJECT_BY_TISSUE = list( 
                                              LG = file.path( PATH_EXPERIMENT_OUTPUT, "06_GlobalHeterogeneityNoBCR_StringentQC", paste0( PROJECT_SHORT_NAME, "_custom.rna.seurat.RDS"))
                                            )

# Cluster markers genes per tissues
PATH_CLUSTER_MARKER_GENES_PER_TISSUE = list(  
                                              LG = file.path( PATH_EXPERIMENT_OUTPUT, "06_GlobalHeterogeneityNoBCR_StringentQC", "allMarkers.tab")
                                            )
...
# -- Names of cell phenotype for each gate CXCR3 x CCR6
...
PHENOTYPE_CXCR3xCCR6_SHARED_CLONES_PHENOTYPES = c( PHENOTYPE_CXCR3xCCR6_NAMES[[ "PosPos"]], 
                                                   PHENOTYPE_CXCR3xCCR6_NAMES[[ "NegPos"]], 
                                                   PHENOTYPE_CXCR3xCCR6_NAMES[[ "NegNeg"]])

# -- Names of cell phenotype for each gate HA x NP
...
# List of genes of interest to plot their expression in different situations
GENES_OF_INTEREST = c( "Ccr6", "Fcer2a", "Cnn3", "Lmo2", "Serpinb1a", "Lta", "Fscn1", "Cxcr3", "Plac8", "Cst3", "Itga4", "Ahr", "Rgs1", 
                       "Lmnb1", "S100a6", "Cd55", "Klf2", "Vim", "Tuba1a", "Marcksl1", "Apoe", "Cd24a", "Fcmr", "Ms4a6c", "Lck", "Nfatc1",
                       "Zbtb32")
