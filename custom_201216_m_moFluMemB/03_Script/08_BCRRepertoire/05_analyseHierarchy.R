...
clonotype_to_analyze = na.omit( unique( as.character( Idents( custom.rna.seurat))))

# Parse the list of clonotype to analyse to build a phylogenetic tree foe each of them
